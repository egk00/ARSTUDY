...
public class cEnemy : MonoBehaviour {
	...
	public void Die()
	{
		...
		for (int i = 0; i <= 4; i++)
		{
			...
			vNewDebris.transform.FindChild("Inside").GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite> ("Enemies/" + vShape.vForm + "/Inside");
			vNewDebris.transform.FindChild ("Inside").GetComponent<SpriteRenderer> ().color = vShape.vColor;
